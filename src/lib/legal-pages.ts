...
> = {
  fr: {
    'about': {
      title: "À propos d'Olkeri",
      intro: [
        "Olkeri est une publication indépendante consacrée à l'intelligence artificielle dans le monde entier, publiée en anglais, en français, en allemand et en espagnol.",
        "Nous couvrons les entreprises, la recherche, la politique, le matériel et les infrastructures qui façonnent l'IA, avec une attention particulière aux régions moins couvertes ailleurs, notamment en Afrique, en Asie et en Amérique latine.",
      ],
      blocks: [
        { heading: 'Nos sujets', body: ["Notre couverture comprend les modèles et les produits, les semi-conducteurs et les infrastructures de calcul, la réglementation et les politiques publiques, l'IA dans l'industrie, et les paysages nationaux de l'IA."] },
        { heading: 'Qui publie Olkeri', body: ["Olkeri est publié et édité par Mark Chweya, éditeur indépendant basé au Kenya. Les décisions éditoriales relèvent de sa responsabilité."] },
        { heading: 'Notre méthode', body: ["Les articles sont rédigés pour Olkeri, et nous créditons la source primaire de toute information rapportée, avec un lien lorsqu'il en existe un.", "Nous utilisons des outils d'IA dans notre processus de production, notamment pour la rédaction, la traduction et l'illustration. Chaque article est publié sous la responsabilité de l'éditeur.", 'Nos illustrations sont réalisées en interne.'] },
        { heading: 'Corrections', body: ["Nous corrigeons rapidement les erreurs factuelles. Écrivez-nous en indiquant le lien de l'article et la correction proposée."] },
        { heading: 'Publicité et indépendance', body: ["Le site diffuse de la publicité, qui peut être servie par des régies tierces. La publicité n'influence pas nos choix éditoriaux."] },
        { heading: 'Langues', body: ["Olkeri publie en anglais, en français, en allemand et en espagnol. Les versions traduites d'un même article sont reliées entre elles."] },
        { heading: 'Contact', body: ['Olkeri', 'Site web : www.olkeri.space', 'Éditeur et rédacteur : Mark Chweya'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    'privacy-policy': {
      title: 'Politique de confidentialité',
      intro: [
        'Bienvenue sur Olkeri Space, accessible à l’adresse olkeri.space.',
        'Cette politique explique comment nous collectons, utilisons et protégeons vos informations lorsque vous utilisez notre site.',
        'En utilisant notre site, vous acceptez les pratiques décrites dans cette politique.',
      ],
      blocks: [
        { heading: 'Informations collectées', body: ["Nous pouvons collecter votre nom, votre adresse e-mail, vos coordonnées, vos inscriptions à la newsletter et les informations envoyées via nos formulaires."] },
        { heading: 'Informations automatiques', body: ["Nous pouvons collecter l'adresse IP, le navigateur, le type d'appareil, le système d'exploitation, les pages consultées, les sources de trafic et la localisation générale."] },
        { heading: 'Utilisation des informations', body: ["Nous utilisons ces données pour envoyer des newsletters, répondre aux demandes, améliorer le site, analyser le trafic, personnaliser le contenu, détecter les abus et respecter nos obligations légales."] },
        { heading: 'Cookies et publicité', body: ["Nous utilisons des cookies pour les performances, les préférences, l'analyse et la publicité. Google AdSense et d'autres partenaires peuvent utiliser des cookies publicitaires."] },
        { heading: 'Sécurité des données', body: ["Nous appliquons des mesures raisonnables pour protéger les informations, mais aucune transmission sur Internet ne peut être garantie comme totalement sûre."] },
        { heading: 'Vie privée des enfants', body: ["Le site ne s'adresse pas aux enfants de moins de 13 ans, et nous ne collectons pas sciemment leurs données personnelles."] },
        { heading: 'Contenu IA', body: ["Olkeri Space publie des actualités, des analyses et des contenus éducatifs sur l'intelligence artificielle. Les informations peuvent devenir obsolètes."] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    'terms-and-conditions': {
      title: 'Conditions générales',
      intro: ["En accédant à olkeri.space, vous acceptez ces conditions générales."],
      blocks: [
        { heading: 'Utilisation du site', body: ["Vous acceptez d'utiliser le site légalement et de ne pas perturber son fonctionnement, distribuer des logiciels malveillants, tenter un accès non autorisé ou extraire le contenu sans permission."] },
        { heading: 'Propriété intellectuelle', body: ["Sauf indication contraire, le contenu publié sur Olkeri Space appartient à Olkeri Space. Vous pouvez le lire et en partager les liens, mais pas le republier ni le vendre sans autorisation."] },
        { heading: 'Services tiers', body: ["Nous pouvons mentionner des entreprises, des produits et des services tiers. Les marques restent la propriété de leurs détenteurs respectifs."] },
        { heading: 'Responsabilité', body: ["Olkeri Space n'est pas responsable des dommages liés à l'utilisation du site, aux erreurs, aux omissions ou aux interruptions de service."] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    'cookie-policy': {
      ...
      blocks: [
        { heading: 'Que sont les cookies ?', body: ["Les cookies sont de petits fichiers stockés sur votre appareil pour améliorer le fonctionnement du site et l'expérience utilisateur."] },
        { heading: 'Cookies utilisés', body: ['Nous pouvons utiliser des cookies essentiels, analytiques, publicitaires et fonctionnels.'] },
        { heading: 'Gestion des cookies', body: ["Vous pouvez bloquer ou supprimer les cookies depuis les paramètres de votre navigateur. Certaines fonctionnalités peuvent alors être limitées."] },
        { heading: 'Cookies tiers', body: ["Google, YouTube, les plateformes sociales et les services d'analyse peuvent déposer leurs propres cookies."] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    disclaimer: {
      title: 'Avertissement',
      intro: ["Les informations publiées sur olkeri.space le sont uniquement à titre informatif et éducatif."],
      blocks: [
        { heading: 'Actualités et analyses', body: ["Nous publions des actualités, des avis, des analyses et des commentaires sur l'intelligence artificielle et la technologie. Les informations peuvent devenir obsolètes après leur publication."] },
        { heading: 'Pas de conseil professionnel', body: ["Le contenu ne constitue pas un conseil juridique, financier, fiscal, commercial ou d'investissement. Consultez un professionnel qualifié si nécessaire."] },
        { heading: 'Liens externes', body: ['Nous ne sommes pas responsables des sites ou des services tiers liés depuis notre plateforme.'] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    'editorial-policy': {
      title: 'Politique éditoriale',
      intro: ["Olkeri Space vise à fournir une couverture fiable, claire et utile de l'intelligence artificielle, de la technologie et de l'innovation."],
      blocks: [
        { heading: 'Indépendance éditoriale', body: ['Nos décisions éditoriales sont indépendantes et ne sont influencées ni par la publicité, ni par les affiliations, ni par les partenariats.'] },
        { heading: 'Exactitude', body: ["Nous nous efforçons de vérifier les faits, d'utiliser des sources crédibles, d'attribuer les informations et de corriger rapidement les erreurs."] },
        { heading: 'Sources', body: ['Nous privilégions les annonces officielles, les documents publics, les travaux de recherche, les dépôts réglementaires et les déclarations de première main.'] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
    'dmca-copyright-policy': {
      title: "Politique DMCA / droits d'auteur",
      intro: ["Olkeri Space respecte les droits de propriété intellectuelle d'autrui."],
      blocks: [
        { heading: 'Propriété du contenu', body: ["Sauf indication contraire, le contenu publié sur olkeri.space appartient à Olkeri Space et est protégé par les lois applicables."] },
        { heading: 'Utilisation autorisée', body: ['Vous pouvez partager des liens et citer de courts extraits en mentionnant la source. Vous ne pouvez pas republier des articles entiers sans autorisation.'] },
        { heading: 'Réclamations', body: ["Envoyez les avis de violation de droits d'auteur à chweyahub@gmail.com, avec pour objet Copyright Infringement Notice."] },
        { heading: 'Contact', body: ['Olkeri Space', 'Site web : olkeri.space'], bullets: ['E-mail : chweyahub@gmail.com'] },
      ],
    },
  },
  de: {
    'about': {
      title: 'Über Olkeri',
      intro: [
        'Olkeri ist eine unabhängige Publikation über künstliche Intelligenz weltweit, veröffentlicht auf Englisch, Französisch, Deutsch und Spanisch.',
        'Wir berichten über Unternehmen, Forschung, Politik, Hardware und Infrastruktur, die die KI prägen, mit besonderem Augenmerk auf Regionen, über die anderswo weniger berichtet wird, darunter Afrika, Asien und Lateinamerika.',
      ],
      blocks: [
        ...
        { heading: 'Wer Olkeri herausgibt', body: ['Olkeri wird von Mark Chweya herausgegeben und redigiert, einem unabhängigen Herausgeber mit Sitz in Kenia. Redaktionelle Entscheidungen liegen in seiner Verantwortung.'] },
        { heading: 'Unsere Arbeitsweise', body: ['Artikel werden für Olkeri recherchiert und geschrieben, und wir nennen die Primärquelle jeder berichteten Entwicklung mit Link, sofern vorhanden.', 'Wir setzen KI-Werkzeuge im Produktionsprozess ein, unter anderem für Entwurf, Übersetzung und Illustration. Jeder Artikel erscheint unter der Verantwortung des Herausgebers.', 'Unsere Bilder werden intern erstellt.'] },
        ...
        { heading: 'Werbung und Unabhängigkeit', body: ['Die Website schaltet Werbung, die von Drittanbietern ausgeliefert werden kann. Werbung hat keinen Einfluss auf unsere redaktionellen Entscheidungen.'] },
        { heading: 'Sprachen', body: ['Olkeri veröffentlicht auf Englisch, Französisch, Deutsch und Spanisch. Übersetzte Fassungen eines Artikels sind miteinander verlinkt.'] },
    ...
    'privacy-policy': {
      ...
      intro: [
        ...
        'Diese Datenschutzerklärung erklärt, wie wir Informationen sammeln, verwenden und schützen, wenn Sie unsere Website nutzen.',
        'Durch die Nutzung der Website stimmen Sie diesen Praktiken zu.',
      ],
      blocks: [
        { heading: 'Welche Informationen wir sammeln', body: ['Wir können Name, E-Mail-Adresse, Kontaktdaten, Newsletter-Anmeldungen und Informationen aus Kontaktformularen erfassen.'] },
        { heading: 'Automatisch erfasste Informationen', body: ['Dazu können IP-Adresse, Browser, Gerät, Betriebssystem, besuchte Seiten, Traffic-Quellen, Sitzungsdauer und allgemeiner Standort gehören.'] },
        { heading: 'Wie wir Informationen nutzen', body: ['Wir verwenden Informationen für Newsletter, Antworten auf Anfragen, Website-Verbesserungen, Traffic-Analyse, Personalisierung, Missbrauchserkennung und rechtliche Pflichten.'] },
        { heading: 'Cookies und Werbung', body: ['Wir nutzen Cookies für Leistung, Einstellungen, Analyse und Werbung. Google AdSense und andere Partner können Werbe-Cookies verwenden.'] },
        { heading: 'Datensicherheit', body: ['Wir nutzen angemessene Schutzmaßnahmen, können aber keine vollständige Sicherheit bei Internetübertragungen garantieren.'] },
        ...
        { heading: 'KI-Inhalte', body: ['Olkeri Space veröffentlicht Nachrichten, Analysen und Bildungsinhalte zu künstlicher Intelligenz. Informationen können veralten.'] },
    ...
    'terms-and-conditions': {
      ...
      blocks: [
        { heading: 'Nutzung der Website', body: ['Sie verpflichten sich, die Website rechtmäßig zu nutzen und keine Gesetze zu verletzen, Malware zu verbreiten, unbefugten Zugriff zu versuchen oder den Betrieb zu stören.'] },
        { heading: 'Geistiges Eigentum', body: ['Sofern nicht anders angegeben, gehört der Inhalt von Olkeri Space Olkeri Space. Sie dürfen Inhalte lesen und Links teilen, aber nicht ohne Erlaubnis republizieren oder verkaufen.'] },
        { heading: 'Drittanbieter', body: ['Wir können Unternehmen, Produkte und Dienste Dritter besprechen. Marken bleiben Eigentum ihrer jeweiligen Inhaber.'] },
        { heading: 'Haftungsbeschränkung', body: ['Olkeri Space haftet nicht für Schäden aus Nutzung der Website, Vertrauen auf Inhalte, Fehler, Auslassungen oder Serviceunterbrechungen.'] },
        { heading: 'Kontakt', body: ['Olkeri Space', 'Website: olkeri.space'], bullets: ['Email: chweyahub@gmail.com'] },
      ],
    },
    'cookie-policy': {
      title: 'Cookie-Richtlinie',
      intro: ['Diese Seite erklärt, wie Olkeri Space Cookies verwendet.'],
      blocks: [
        { heading: 'Was sind Cookies?', body: ['Cookies sind kleine Dateien auf Ihrem Gerät, die Funktionen und Nutzererfahrung verbessern.'] },
        { heading: 'Welche Cookies wir nutzen', body: ['Wir können notwendige, analytische, werbliche und funktionale Cookies verwenden.'] },
        { heading: 'Cookies verwalten', body: ['Sie können Cookies in Ihren Browser-Einstellungen blockieren oder löschen. Manche Funktionen können dadurch eingeschränkt sein.'] },
        { heading: 'Cookies von Dritten', body: ['Google, YouTube, soziale Plattformen und Analyseanbieter können eigene Cookies setzen.'] },
        { heading: 'Kontakt', body: ['Olkeri Space', 'Website: olkeri.space'], bullets: ['Email: chweyahub@gmail.com'] },
      ],
    },
    disclaimer: {
      ...
      blocks: [
        { heading: 'Berichterstattung', body: ['Wir veröffentlichen Nachrichten, Bewertungen, Analysen und Kommentare zu künstlicher Intelligenz und Technologie. Informationen können nach der Veröffentlichung veralten.'] },
        { heading: 'Keine professionelle Beratung', body: ['Nichts auf dieser Website ist Rechts-, Finanz-, Steuer-, Geschäfts- oder Anlageberatung. Wenden Sie sich bei Bedarf an qualifizierte Fachleute.'] },
        { heading: 'Externe Links', body: ['Wir sind nicht verantwortlich für Websites oder Dienste Dritter.'] },
        { heading: 'Kontakt', body: ['Olkeri Space', 'Website: olkeri.space'], bullets: ['Email: chweyahub@gmail.com'] },
      ],
    },
    'editorial-policy': {
      title: 'Redaktionelle Richtlinie',
      intro: ['Olkeri Space möchte verlässliche und verständliche Berichterstattung über KI, Technologie, Innovation und digitale Transformation bieten.'],
      blocks: [
        { heading: 'Redaktionelle Unabhängigkeit', body: ['Unsere redaktionellen Entscheidungen sind unabhängig und werden nicht durch Werbung, Affiliate-Beziehungen oder Partnerschaften beeinflusst.'] },
        { heading: 'Genauigkeit', body: ['Wir bemühen uns, Fakten zu prüfen, glaubwürdige Quellen zu nutzen, Informationen zuzuordnen und Fehler zeitnah zu korrigieren.'] },
        { heading: 'Quellen', body: ['Wir bevorzugen offizielle Ankündigungen, öffentliche Dokumentation, Forschungsarbeiten, regulatorische Unterlagen und Aussagen aus erster Hand.'] },
        { heading: 'Kontakt', body: ['Olkeri Space', 'Website: olkeri.space'], bullets: ['Email: chweyahub@gmail.com'] },
      ],
    },
    'dmca-copyright-policy': {
      ...
      blocks: [
        { heading: 'Eigentum am Inhalt', body: ['Sofern nicht anders angegeben, gehört der Inhalt auf olkeri.space Olkeri Space und ist urheberrechtlich geschützt.'] },
        { heading: 'Erlaubte Nutzung', body: ['Sie dürfen Links teilen und kurze Ausschnitte mit Quellenangabe zitieren. Ganze Artikel dürfen ohne Erlaubnis nicht erneut veröffentlicht werden.'] },
        { heading: 'Ansprüche', body: ['Senden Sie Urheberrechtsbeschwerden an chweyahub@gmail.com mit dem Betreff Copyright Infringement Notice.'] },
        { heading: 'Kontakt', body: ['Olkeri Space', 'Website: olkeri.space'], bullets: ['Email: chweyahub@gmail.com'] },
      ],
    },
  },
