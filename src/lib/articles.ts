...
export const appCopy = {
  ...
  es: {
    ...
    contact: {
      ...
      intro: 'Una noticia, una corrección, una colaboración — cuéntanoslo. Respondemos en 24 horas.',
      name: 'Tu nombre',
    ...
    startProject: {
      ...
      intro: 'Olkeri cubre la actualidad de la IA en todo el mundo, cada día, en cuatro idiomas. Envíanos noticias, correcciones o solicitudes de colaboración.',
      cta: 'Contáctanos',
    },
    legalLabels: {
